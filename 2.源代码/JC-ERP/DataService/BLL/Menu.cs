...
namespace DataService.BLL
{
    ...
    {
        private readonly DataService.DAL.Menu dal = new DataService.DAL.Menu();
        public Menu()
        { }
        #region  BasicMethod
        ...
        /// 获得数据列表
        /// </summary>
        public List<DataService.Model.Menu> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<DataService.Model.Menu> DataTableToList(DataTable dt)
        {
            List<DataService.Model.Menu> modelList = new List<DataService.Model.Menu>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                DataService.Model.Menu model;
